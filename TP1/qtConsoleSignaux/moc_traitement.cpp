/****************************************************************************
** Meta object code from reading C++ file 'traitement.h'
**
...
#error "The header file 'traitement.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 11, 13), // "finTraitement"
QT_MOC_LITERAL(2, 25, 0) // ""

    },
    "Traitement\0finTraitement\0"
};
...
void Traitement::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->finTraitement((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Traitement::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Traitement::finTraitement)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Traitement::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Traitement.data,
      qt_meta_data_Traitement,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void Traitement::finTraitement(QString _t1)
{
